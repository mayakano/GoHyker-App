...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { available_seat: @itinerary.available_seat, description: @itinerary.description, end_date: @itinerary.end_date, projected_eta: @itinerary.projected_eta, start_date: @itinerary.start_date, user_id: @itinerary.user_id } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { available_seat: @itinerary.available_seat, description: @itinerary.description, end_date: @itinerary.end_date, projected_eta: @itinerary.projected_eta, start_date: @itinerary.start_date, user_id: @itinerary.user_id } }
